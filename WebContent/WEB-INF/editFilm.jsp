...
<form:form action="editFilm.do" method="POST" modelAttribute="film">
		...
		<form:input path="description" default=${film.title } placeholder=${film.description }/>
		<form:errors path="description" />
		<br />
		<form:label path="releaseYear">Release Year:</form:label>
		<form:input path="releaseYear" default=${film.title } placeholder=${film.releaseYear }/>
		<form:errors path="releaseYear" />
		<br />
		<form:select path="languageId">Language Currently Set To ${film.languageId }: 
			<form:option value="1">English</form:option default=${film.languageId } placeholder=${film.languageId }>
		...
		<form:select path="specialFeatures">Special Features: 
			<form:option value="Trailers">Trailers</form:option default=${film.specialFeatures } placeholder=${film.specialFeatures }>
